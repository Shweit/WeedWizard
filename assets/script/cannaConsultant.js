...
document.addEventListener('DOMContentLoaded', function() {
    let cannaConsultantChat_init = document.querySelectorAll('.cannaConsultantChat-init');
    [...cannaConsultantChat_init].forEach(function(element) {
        let chat = element.querySelector('#chat');
        let chatSend = element.querySelector('#chat-send');
        let textarea = element.querySelector('#message');
        let chat_input_div = element.querySelector('#chat-input-div');
        ...
        function submitForm() {
            if (textarea.value) {
                ...
                let instructions = "";
                if (element.querySelector('#cannaconsultant_instructions')) {
                    instructions = element.querySelector('#cannaconsultant_instructions').value;
                }

                let thread = null;
                if (element.querySelector('#cannaconsultant_thread')) {
                    thread = element.querySelector('#cannaconsultant_thread').value;
                }
        ...
        function removeLoadingBubble() {
            let loading = chat.querySelector('#loading');
            loading.remove();
        }
