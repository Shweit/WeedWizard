...
class BudBashLocatorTest extends WebTestCase
{
    ...
    public function testCreateBudBashParty(): void
    {
        $this->loadFixtures([
            ...
            \App\DataFixtures\BudBashFixtures::class,
        ]);
        ...
        $form['bud_bash[CheckAttendances]'] = false;
        ...
        $party = $this->entityManager->getRepository(\App\Entity\BudBash::class)->findOneBy(['name' => 'Test Party', 'address' => 'Marienplatz 1, 80331 München']);
    ...
    public function testCreateBudBashPartyWithCheckAttendance(): void
    {
        ...
        $form['bud_bash[address_city]'] = 'München';
        $form['bud_bash[entrance_fee]'] = '10';
        $form['bud_bash[CheckAttendances]'] = true;
        $form['bud_bash[extraInfo]'] = 'Test Info';
        ...
        $checkAttendance = $this->entityManager->getRepository(\App\Entity\BudBashCheckAttendance::class)->findOneBy(['BudBashParty' => $party]);
