...
class MapMarkersFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $marker->setTitle('Private Test Marker');
        ...
        $marker = new MapMarkers();
        $marker->setTitle('Public Test Marker');
        $marker->setDescription('Public Test Description');
        $marker->setCoordinates('51.038994765756705,6.694787679487045');
        $marker->setUser($user);
        $manager->persist($marker);
